...
exercises: [
{ c:"variables & types", t:"Order of operations", book:"ch01", sec:0,
  fb:"If your numbers came out wrong, precedence is the culprit: * binds before +, parentheses override everything, and ** is exponentiation.",
...
{ c:"strings", t:"Join and repeat", book:"ch01", sec:2,
  fb:"If you saw a TypeError or a wrong join, remember: + joins two strings with nothing added between them, * repeats a string an integer number of times, and len() counts characters.",
...
{ c:"variables & types", t:"Name and age", book:"ch01", sec:5,
  fb:"The classic failure here is joining a number straight into text — + refuses that. Wrap the number in str() first.",
...
{ c:"variables & types", t:"Minutes in a week", book:"ch01", sec:3,
  fb:"Store 60 * 24 once under a clear name and reuse the variable — if your second line repeated the arithmetic, reread how assignment works.",
